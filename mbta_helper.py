...
def get_json(url: str) -> dict:
    ...
    # we asked AI what our problem was was, and recommended to add this to the code
...
def get_nearest_station(latitude: str, longitude: str) -> tuple[str, bool]:
    ...
    # if there is no station near, it returns none
...
def get_nearby_coffee (latitude: str, longitude: str) -> list:
    ...
    # this link specifies the chosen radius for the nearby coffe shop 
...
def find_stop_near(place_name: str) -> tuple[str, bool]:
    ...
    # if there is no nearby MBTA station, it will also return a message 
    # pass
...
def main():
    ...
    # this tests the funtion by testing out a loction 
